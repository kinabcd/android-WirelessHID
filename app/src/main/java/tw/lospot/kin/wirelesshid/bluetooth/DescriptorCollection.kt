...
object DescriptorCollection {
    //BluetoothHidDevice.SUBCLASS1_COMBO
     val MOUSE_ABSOLUTE = byteArrayOf(
        ...
        0x19.toByte(), 0xb5.toByte(),               //     USAGE_MINIMUM (Scan Next Track)
        0x29.toByte(), 0xb7.toByte(),               //     USAGE_MAXIMUM (Stop)
        0x09.toByte(), 0xcd.toByte(),               //     USAGE (Play/Pause)
        0x81.toByte(), 0x02.toByte(),               //     INPUT (Data,Var,Abs)

        0x95.toByte(), 0x04.toByte(),               //     Report Count (1)
        ...
        0x81.toByte(), 0x02.toByte(),               //     INPUT (Data,Var,Abs)
        0x95.toByte(), 0x01.toByte(),               //     REPORT_COUNT (1) - padding
        0x81.toByte(), 0x03.toByte(),               //     INPUT (Constant,Var,Abs)
        0xc0.toByte(),                              // END_COLLECTION
    )// End
